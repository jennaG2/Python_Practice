...
# Remove stopwords
stopwords_list = ["the", "is", "of", "to", "a", "for", "on", "with", "that"]  # Add more stopwords as needed
...
# Apply stopwords removal before vectorization
train_dataframe['review'] = train_dataframe['review'].apply(remove_stopwords)
valid_dataframe['review'] = valid_dataframe['review'].apply(remove_stopwords)
